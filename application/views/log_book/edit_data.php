          ...
          <div class="card-body">        
            ...
            <div class="form-group" id="alasan" style="display: none;">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="alasan" placeholder="Ex: Kerumitan struktur data " value="<?= $this->input->post('alasan') ?? $row->alasan;?>">
              </div>                                         
            </div>
            ...
            <div class="form-group" id="bukti" style="display: none;">
              <label>Bukti</label>
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" name="bukti" placeholder="Ex: Kerumitan struktur data " value="<?= $this->input->post('bukti') ?? $row->bukti;?>">
                </div>                                         
              </div>
            </div>
...
<script>
    // Menjalankan JavaScript setelah dokumen selesai dimuat
    ...
    // Mendengarkan perubahan pada dropdown realisasi
    document.getElementById('realisasi').addEventListener('change', function() {
        var realisasi = this.value;
        if (realisasi == 'TIDAK') {
            document.getElementById('alasan').style.display = 'block';
            document.getElementById('bukti').style.display = 'none';
        } else {
